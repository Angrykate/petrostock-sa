class AlerteService:
    ...
    # L'EDA a montré : < 30j (orange), < 14j (rouge), < 7j (critique)
    # Ces seuils sont justifiés par le délai fournisseur moyen de 8,5 jours
    SEUIL_STOCK_MODERE_JOURS = 30   # Alerte orange : déclenche une vigilance
    SEUIL_STOCK_BAS_JOURS = 14      # Alerte rouge : commande nécessaire
    SEUIL_STOCK_CRITIQUE_JOURS = 7  # Alerte critique : urgence absolue
    COEFFICIENT_SECURITE = 0.85     # ×0.85 sur prévisions (sous-estimer > surestimer)
